...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **1. Single-Prompt Baseline** | **18.39%** | **69.77%** | **0.0%** | **0.0%** | **27.37/100** | `FAILED` |
| **2. Old Pipeline (Legacy CLI / Thiên)** | **14.14%** | **66.67%** | **100.0%** | **100.0%** | **59.95/100** | `FAILED` |
| **3. New Multi-Agent CLSG (Antigravity)** | **100.0%** | **100.0%** | **100.0%** | **100.0%** | **100.0/100** | `PASSED` |
...
- **Single-Prompt Baseline (69.77%)**: Lạm dụng tiếng Anh bồi nghiêm trọng (`train model`, `apply filter`, `predict nhãn`, `fine-tune`, `accuracy`).
- **Old Legacy Pipeline (66.67%)**: Vẫn còn sót các động từ tiếng Anh chưa Việt hóa (`optimize`, `train`).
- **New Multi-Agent System (100.0%)**: Đạt 100% nhờ nạp trực tiếp bộ quy chuẩn sư phạm và 6.766 thuật ngữ từ kho từ vựng LPMDataset.
